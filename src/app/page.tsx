...
function LandingHeader() {
  return (
    <header className="px-4 lg:px-6 h-16 flex items-center bg-background/95 backdrop-blur-sm fixed top-0 w-full z-50 border-b">
      <Link
        href="/"
        className="flex items-center justify-center font-headline font-semibold text-lg"
      >
  ...
  return (
    <div className="flex flex-col min-h-[100dvh] bg-background">
      ...
      <main className="flex-1">
            ...
            <div className="grid max-w-screen-xl mx-auto gap-8 px-4 sm:px-6 md:px-10 md:grid-cols-2 md:gap-16 items-center">
              <div>
                ...
                <p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl mt-4">
                  PayDayFlow.me provides the tools you need to track spending,
                  manage bills, and grow your net worth. All in one place.
                </p>
        ...
        <section
          id="features"
          className="w-full py-12 md:py-24 lg:py-32 bg-muted/40 mt-12 md:mt-24"
        >
          <div className="container space-y-12 px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <div className="inline-block rounded-lg bg-card border px-3 py-1 text-sm">
                  Key Features
                </div>
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  From budgeting to AI-powered insights, we&apos;ve got you
                  covered.
                </p>
              </div>
            </div>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-muted-foreground">
          &copy; 2024 PayDayFlow.me. All rights reserved.
        </p>
